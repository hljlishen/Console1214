...
{
    class S8J_EvaluationChapter : IChapterBuilder
    {
        public Chapter GetChapter()
        {
            ...
            List<object[]> content = new List<object[]>()
            {
                ...
                new object[] { "能够对系统进行装配，使型号1、型号2筒弹进退链轮传动系统运行", "25" },
            ...
            c.Contents.Add(tab);
            c.Contents.Add(new NavigationContent(this, new S8J_StepChapter(), null));
            return c;
        }
    }
}
