...
{
    class S8I_InstrumentChapter : IChapterBuilder
    {
        public Chapter GetChapter()
        {
            ...
            this.AddPicture(c, new Bitmap(@"img\8\Intermediate\1.png"));

            this.AddTextTitle(c, "4)PLC梯形图");
            this.AddPicture(c, new Bitmap(@"img\8\Intermediate\2.png"));

            this.AddTextTitle(c, "5)使用工具");
            this.AddText(c, "百分表、磁力表座、卡尺、电动板手、无反弹锤、黄油枪");

            tab = new TableContent(headers, headerTypes) { Caption = "训练器材-工具" };
            contents.Clear();
            contents.Add(new object[] { "工具", "百分表套件", "DG01", "待定", new Bitmap(@"img\8\Intermediate\t1\1.png") });
            contents.Add(new object[] { "工具", "磁力表座", "DG02", "待定", new Bitmap(@"img\8\Intermediate\t1\2.png") });
            contents.Add(new object[] { "工具", "千分尺", "DG03", "待定", new Bitmap(@"img\8\Intermediate\t1\3.png") });
            ...
            contents.Add(new object[] { "仪表", "振动测量仪", "DG07", "待定", new Bitmap(@"img\8\Intermediate\t1\7.png") });
            contents.Add(new object[] { "仪表", "噪声测试仪", "DG08", "待定", new Bitmap(@"img\8\Intermediate\t1\8.png") });
            
            tab.Content.AddRange(contents);
            c.Contents.Add(tab);

            c.Contents.Add(new NavigationContent(this, new S8I_AimChapter(), new S8I_CircuitStructeursChapter()));
