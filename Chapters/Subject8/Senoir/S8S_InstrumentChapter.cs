...
{
    class S8S_InstrumentChapter : IChapterBuilder
    {
        public Chapter GetChapter()
        {
            ...
            this.AddText(c, "钢板尺、卡尺、六方扳手、电动板手、力矩板手、无反弹锤、黄油枪");

            tab = new TableContent(headers, headerTypes) { Caption = "训练器材-工具" };
            contents.Clear();
            contents.Add(new object[] { "工具", "钢板尺", "DG01", "待定", new Bitmap(@"img\8\Senior\t1\1.png") });
            contents.Add(new object[] { "工具", "卡尺", "DG02", "待定", new Bitmap(@"img\8\Senior\t1\2.png") });
            contents.Add(new object[] { "工具", "六方板手", "DG03", "待定", new Bitmap(@"img\8\Senior\t1\3.png") });
            contents.Add(new object[] { "工具", "电动扳手", "DG04", "待定", new Bitmap(@"img\9\t2\3.png") });
            contents.Add(new object[] { "工具", "力矩扳手", "DG05", "待定", new Bitmap(@"img\8\Junior\t2\2.png") });
            contents.Add(new object[] { "工具", "无反弹锤", "DG06", "待定", new Bitmap(@"img\9\t2\5.png") });
            contents.Add(new object[] { "工具", "黄油枪", "DG07", "待定", new Bitmap(@"img\9\t2\6.png") });
            contents.Add(new object[] { "仪器", "振动传感器", "DG08", "待定", new Bitmap(@"img\8\Senior\t1\8.png") });
            contents.Add(new object[] { "仪器", "噪声传感器", "DG09", "待定", new Bitmap(@"img\8\Senior\t1\9.png") });
            contents.Add(new object[] { "软件", "测量分析软件", "DG10", "待定", new Bitmap(@"img\8\Senior\t1\10.png") });
            tab.Content.AddRange(contents); 
            c.Contents.Add(tab);

            c.Contents.Add(new NavigationContent(this, new S8S_AimChapter(), new S8S_CircuitStructuresChapter()));
            return c;
        }
    }
}
