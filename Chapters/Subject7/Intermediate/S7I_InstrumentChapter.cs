...
{
    class S7I_InstrumentChapter : IChapterBuilder
    {
        public Chapter GetChapter()
        {
            ...
            this.AddText(c, "塞尺、卡尺、电动扳手、卡簧钳、六方扳手、无反弹锤、油脂润滑泵");
            ...
            contents.Add(new object[] { "工具", "卡簧钳", "DG04", "待定", new Bitmap(@"img\7\Junior\t2\2.png") });
            ...
            contents.Add(new object[] { "工具", "油脂润滑泵", "DG07", "待定", new Bitmap(@"img\7\Intermediate\t1\7.png") });
            contents.Add(new object[] { "仪表", "振动测量仪", "DG08", "待定", new Bitmap(@"img\7\Intermediate\t1\8.png") });
            contents.Add(new object[] { "仪表", "噪声测试仪", "DG09", "待定", new Bitmap(@"img\7\Intermediate\t1\9.png") });
            tab.Content.AddRange(contents);
            c.Contents.Add(tab);

            c.Contents.Add(new NavigationContent(this, new S7I_AimChapter(), new S7I_CircuitStructeursChapter()));
