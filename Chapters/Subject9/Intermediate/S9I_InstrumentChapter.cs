...
{
    class S9I_InstrumentChapter : IChapterBuilder
    {
        public Chapter GetChapter()
        {
            var c = new Chapter("训练器材");
            ...
            this.AddText(c, "振动测量仪、噪声测试仪");

            tab = new TableContent(headers, headerTypes) { Caption = "训练器材-工具" };
            contents.Clear();
            contents.Add(new object[] { "工具", "六方扳手", "DG01", "待定", new Bitmap(@"img\9\Intermediate\t2\1.png") });
            contents.Add(new object[] { "工具", "无反弹锤", "DG02", "待定", new Bitmap(@"img\9\Intermediate\t2\2.png") });
            contents.Add(new object[] { "工具", "电动扳手", "DG03", "待定", new Bitmap(@"img\9\Intermediate\t2\3.png") });
            contents.Add(new object[] { "工具", "塞尺", "DG04", "待定", new Bitmap(@"img\9\Intermediate\t2\4.png") });
            contents.Add(new object[] { "工具", "百分表套件", "DG05", "待定", new Bitmap(@"img\9\Intermediate\t2\5.png") });
            contents.Add(new object[] { "工具", "磁力表座", "DG06", "待定", new Bitmap(@"img\9\Intermediate\t2\6.png") });
            contents.Add(new object[] { "工具", "油脂润滑泵", "DG07", "待定", new Bitmap(@"img\9\Intermediate\t2\7.png") });
            contents.Add(new object[] { "工具", "振动测量仪", "DG08", "待定", new Bitmap(@"img\9\Intermediate\t2\8.png") });
            contents.Add(new object[] { "工具", "噪声测试仪", "DG09", "待定", new Bitmap(@"img\9\Intermediate\t2\9.png") });
            tab.Content.AddRange(contents);
            c.Contents.Add(tab);
            c.Contents.Add(new NavigationContent(this, new S9I_AimChapter(), new S9I_CircuitStructuresChapter()));
            return c;
        }
    }
}
